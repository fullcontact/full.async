(defproject fullcontact/full.bootstrap "0.4.19"
  ...
  :dependencies [[org.clojure/clojure "1.6.0"]
                 ...
                 [fullcontact/full.time "0.4.19"]
                 [fullcontact/camelsnake "0.4.19"]
                 [fullcontact/full.json "0.4.19"]
                 [fullcontact/full.async "0.4.19"]
                 [fullcontact/full.dev "0.4.19"]
                 [fullcontact/full.cache "0.4.19"]
                 [fullcontact/full.metrics "0.4.19"]
                 [fullcontact/full.http "0.4.19"]]
