(defproject fullcontact/full.bootstrap "0.8.13"
  ...
  :dependencies [[org.clojure/clojure "1.7.0"]
                 ...
                 [fullcontact/full.time "0.8.13"]
                 [fullcontact/camelsnake "0.8.13"]
                 [fullcontact/full.json "0.8.13"]
                 [fullcontact/full.async "0.8.13"]
                 [fullcontact/full.dev "0.8.13"]
                 [fullcontact/full.cache "0.8.13"]
                 [fullcontact/full.metrics "0.8.13"]
                 [fullcontact/full.http "0.8.13"]]
