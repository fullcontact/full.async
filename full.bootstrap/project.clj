(defproject fullcontact/full.bootstrap "0.8.8"
  ...
  :dependencies [[org.clojure/clojure "1.7.0"]
                 ...
                 [fullcontact/full.time "0.8.8"]
                 [fullcontact/camelsnake "0.8.8"]
                 [fullcontact/full.json "0.8.8"]
                 [fullcontact/full.async "0.8.8"]
                 [fullcontact/full.dev "0.8.8"]
                 [fullcontact/full.cache "0.8.8"]
                 [fullcontact/full.metrics "0.8.8"]
