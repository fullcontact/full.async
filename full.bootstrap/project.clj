(defproject fullcontact/full.bootstrap "0.4.22"
  ...
  :dependencies [[org.clojure/clojure "1.6.0"]
                 ...
                 [fullcontact/full.time "0.4.22"]
                 [fullcontact/camelsnake "0.4.22"]
                 [fullcontact/full.json "0.4.22"]
                 [fullcontact/full.async "0.4.22"]
                 [fullcontact/full.dev "0.4.22"]
                 [fullcontact/full.cache "0.4.22"]
